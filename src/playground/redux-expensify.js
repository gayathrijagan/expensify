...
store.subscribe(() => {
    ...
    const visibleExpenses = getVisibleItems(state.expenses, state.filters);
    console.log(visibleExpenses);
});

const expense1 = store.dispatch(addExpense({description: 'Rent', amount: 100, createdAt: 250}));
...
//sstore.dispatch(setStartDate(124));
